import { PICK_UP_POINT_LIST, SAVE_PICK_UP_POINT_LIST,PIN_CODE_CALL,ADD_ADDRESS,SELECT_ADDRESS,
     REMOVE_ALL, REMOVE_INDEX_ELEMENT, INCREMENT_DECREMENT_VALUE, INITIALIZE_VIEWCART_DATA } from './types';
