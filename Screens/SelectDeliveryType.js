                ...
                >
                    ...
                    <View style={styles.deliveryContainer}>
                        <View style={styles.leftDeliveryContainer}>
                            ...
                            <Text style={{ fontSize: 11, color: 'black' }}>You can collect your order from a ANNAPURNA Ready Pick-up point. Select a self Pick-up Point near you and a convenient time slot.</Text>
